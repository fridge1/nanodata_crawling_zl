...
from apps.ACB.acb_score import GetScores
from apps.ACB.tools import get_match_id_score
...
# 设置日志
logger = LogMgr.get('AcbBasketball_score_svr')


class AcbBasketballScore(object):
    data = dict()
    topic = ''
    cnt = 0
