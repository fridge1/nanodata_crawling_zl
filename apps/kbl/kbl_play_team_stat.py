                ...
                for team_id in team_id_list:
                    ...
                    for key, value in player_stat_info.items():
                        ...
                        if int(info_list[9]) == 0:
                            ...
                            player_stat_dict['free_throws_accuracy'] = round(
                                int(info_list[8]) / int(info_list[9]) * 100)
                        ...
                        if int(info_list[11]) == 0:
                            ...
                            player_stat_dict['three_points_accuracy'] = round(
                                int(info_list[10]) / int(info_list[11]) * 100)
                        ...
                        if player_stat_dict['field_goals_total'] == 0:
                            ...
                            player_stat_dict['field_goals_accuracy'] = round(
                                player_stat_dict['field_goals_scored'] / player_stat_dict['field_goals_total'] * 100)
            ...
            async for player_stat, match_id in self.get_player_stat():
                ...
                for team_id in team_id_list:
                    ...
                    if int(team_stat_info['fg_a']) == 0:
                        ...
                        team_stat_dict['two_pointers_accuracy'] = round(
                            int(team_stat_info['fg']) / int(team_stat_info['fg_a']) * 100)
                    ...
                    if int(team_stat_info['threep_a']) == 0:
                        ...
                        team_stat_dict['three_pointers_accuracy'] = round(
                            int(team_stat_info['threep']) / int(team_stat_info['threep_a']) * 100)
                    ...
                    if team_stat_dict['field_goals_total'] == 0:
                        ...
                        team_stat_dict['field_goals_accuracy'] = round(
                            team_stat_dict['field_goals_scored'] / team_stat_dict['field_goals_total'] * 100)
                    ...
                    if team_stat_dict['free_throws_total'] == 0:
                        ...
                        team_stat_dict['free_throws_accuracy'] = round(
                            team_stat_dict['free_throws_scored'] / team_stat_dict['free_throws_total'] * 100)
