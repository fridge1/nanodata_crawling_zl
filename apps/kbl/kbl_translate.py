...
words = {'없음': '', '게임중단': '中断', '작전시간': '短暂停', '게임종료': '比赛结束', '시간설정': '设定时间', '2점슛성공': '两分球命中', '2점슛시도': '两分球不中', '자유투성공': '罚球命中', '자유투시도': '罚球不中', '3점슛성공': '三分球命中', '3점슛시도': '三分球不中', '덩크슛성공': '扣篮命中', '덩크슛시도': '扣篮不中', '공격리바운드': '进攻篮板', '수비리바운드': '防守篮板', '어시스트': '助攻', '스틸': '抢断', '블록': '封盖', '턴오버': '失误', '파울자유투': '犯规，对方罚球', '파울': '犯规', '팀속공': '球队快攻', '팀리바운드': '全队篮板', 'Illegal Def': '', '굿디펜스': '防守', '팀턴오버': '全队失误', '기타파울': '其他犯规', '팀파울': '全队犯规', '엘보우 파울': '肘部犯规', '플레그런트 파울': '三秒违例', '파이팅 파울': '违体犯规', '펀칭 파울"': 'Punching 犯规', '퍼스널 파울': '个人犯规', '테크니컬 파울': '技术犯规', '정상교체': '正常换人', '부상': '受伤', '퇴장': '离场', '5반칙': '犯规犯满', '디스퀄리파잉': '取消资格', '기타 퇴장': '其他离场','교체IN': '被换上', '교체OUT': '被换下'}
