...
class GetMatchObj():
    ...
    async def get_match_info(self, game_id):
        ...
        if url_api_res['line_up']['status'] == 0:
            ...
            home_half_score = int(url_api_res['quarter_score'][home_team_id]['Q1']) + int(
                url_api_res['quarter_score'][home_team_id]['Q2'])
            away_half_score = int(url_api_res['quarter_score'][away_team_id]['Q1']) + int(
                url_api_res['quarter_score'][away_team_id]['Q2'])
            home_scores = []
