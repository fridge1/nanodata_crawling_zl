...
from apps.NBL.tools import get_nbl_nana_player_name_zh

words = {'game end': '比赛结束', 'period end': '赛节结束', 'rebound defensive': '防守篮板', '2pt layup missed': '2分上篮不中', 'steal ': '抢断',
 ...
 'rebound offensive': '进攻篮板', 'block ': '封盖', 'turnover backcourt': '回场违例', '2pt fadeaway': '2分后仰投篮命中', 'assist ': '助攻',
 ...
 'freethrow 1of3': '第1罚(3罚):命中', '3pt jumpshot': '3分跳投命中', '2pt hookshot missed': '2分勾手投篮不中', 'turnover travel': '走步失误',
 'foul unsportsmanlike': '违体犯规', '2pt drivinglayup': '2分突破上篮命中', 'jumpshot missed': '3分跳投不中', '2pt layup ': '2分上篮命中',
 '2pt floatingjumpshot missed': '2分漂移跳投不中', '3pt stepbackjumpshot': '3分后撤步跳投不中', '2pt floatingjumpshot': '2分漂移跳投命中',
 'freethrow 2of2 ': '第2罚(2罚):不中', 'jumpball heldball': '跳球 双方持球', 'turnover offensive': '进攻失误',
 'foul offensive': '进攻犯规', 'period start': '赛节开始', 'freethrow 1of1': '第1罚(2罚):命中', 'turnover ballhandling': '运球失误',
 ...
 '3pt stepbackjumpshot missed': '3分后撤步跳投不中', '3pt fadeaway missed': '3分后仰投篮不中', 'freethrow 3of3 missed': '第3罚(3罚):不中',
 ...
 '3pt pullupjumpshotmissed':'3分急停跳投不中','3pt pullupjumpshotmade':'3分急停跳投命中','2pt stepbackjumpshot':'2分后撤步跳投命中','3pt fadeaway':'3分后仰跳投','3pt pullup':'3分急停'}
