import requests
from apps.eur_basketball_spider.tools import tree_parse,time_stamp,manager_name,team_id,translate_dict,team_name
import re
...
def get_coach_info():
    ...
    team_map_url = 'https://www.euroleague.net/competition/teams?seasoncode=E%s'
    for season_id in season_ids:
        teams_res = requests.get(team_map_url % season_id,headers=headers)
