...
class BleagueAcbBasketballTeam(BaseModel):
...
class BleagueAcbBasketballPlayer(BaseModel):
...
# 教练表
class BleagueAcbBasketballManager(BaseModel):
...
class BleagueAcbBasketballVenue(BaseModel):
...
# 城市表  -----已存
class BleagueAcbBasketballCity(BaseModel):
...
# 毕业院校 ----- 已存
class BleagueAcbBasketballSchool(BaseModel):
...
# 赛事
class BleagueAcbBasketballCompetition(BaseModel):
...
# 赛季
class BleagueAcbBasketballSeason(BaseModel):
...
# 比赛阶段
class BleagueAcbBasketballStage(BaseModel):
...
class BleagueAcbBasketballMatch(BaseModel):
...
# 球队阵容
class BleagueAcbBasketballTeamLineup(BaseModel):
...
# 单场阵容信息
class BleagueAcbBasketballLineupInfo(BaseModel):
...
# 积分榜升降级
class BleagueAcbBasketballPromotion(BaseModel):
...
# 积分榜
class BleagueAcbBasketballTable(BaseModel):
...
# 积分榜详细数据
class BleagueAcbBasketballTableRow(BaseModel):
...
# 单场比赛球队统计        --------第三页   已存
class BleagueAcbBasketballTeamStats(BaseModel):
...
# 单场比赛球员统计       -------第三页内容  核心
class BleagueAcbBasketballPlayerStats(BaseModel):
...
# 球队榜统计
class BleagueAcbBasketballTeamTotal(BaseModel):
...
# 球员榜统计
class BleagueAcbBasketballPlayerTotal(BaseModel):
...
# 球队榜统计(计算)
class BleagueAcbBasketballTeamTotalCal(BaseModel):
...
# 球员榜统计(计算)
class BleagueAcbBasketballPlayerTotalCal(BaseModel):
